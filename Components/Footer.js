      ...
      <div className="row">
        <div className="col-6 col-md-2">
          <span className="footer-text">
            <Link href="/aboutus">About Vedayuu</Link>
          </span>
          <span className="footer-text">Our Story</span>
          <span className="footer-text">Design Philosophy</span>
          <span className="footer-text">Design Language</span>
        ...
        <div className="col-6 col-md-2 align-items-end align-items-md-start">
          ...
          <span className="footer-text">CARE</span>
          <span className="footer-text">Warranty</span>
        </div>
        <div className="col-6 col-md-2">
          <span className="footer-text">Refund</span>
          <span className="footer-text">Shipping and Delivery</span>
        </div>
