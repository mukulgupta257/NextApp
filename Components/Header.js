    ...
    <div className="header-wrapper">
      <div className="header-1">
        <div className="bar-wrapper">
          ...
          >
            <path
              ...
              d="M1.125,9.729h29.25A1.178,1.178,0,0,0,31.5,8.5V5.443a1.178,1.178,0,0,0-1.125-1.224H1.125A1.178,1.178,0,0,0,0,5.443V8.5A1.178,1.178,0,0,0,1.125,9.729Zm0,12.245h29.25A1.178,1.178,0,0,0,31.5,20.749V17.688a1.178,1.178,0,0,0-1.125-1.224H1.125A1.178,1.178,0,0,0,0,17.688v3.061A1.178,1.178,0,0,0,1.125,21.974Zm0,12.245h29.25A1.178,1.178,0,0,0,31.5,32.994V29.933a1.178,1.178,0,0,0-1.125-1.224H1.125A1.178,1.178,0,0,0,0,29.933v3.061A1.178,1.178,0,0,0,1.125,34.219Z"
        ...
        <div className="icon-wrapper">
          {user && user.is_logged ? (
            <svg
              className="icon d-md-block d-none"
          ...
          >
            ...
            >
              <path
                id="Path_1"
                data-name="Path 1"
                d="M28.5,18c0,7.456-5.373,13.5-12,13.5S4.5,25.456,4.5,18,9.873,4.5,16.5,4.5,28.5,10.544,28.5,18Z"
                fill="none"
                stroke="#000"
                strokeLinecap="round"
          ...
          >
            ...
            <path
              id="Path_5"
              data-name="Path 5"
              d="M1.5,1.5h6l4.02,18.746a2.96,2.96,0,0,0,3,2.254H29.1a2.96,2.96,0,0,0,3-2.254L34.5,8.5H9"
              fill="none"
              stroke="#000"
              strokeLinecap="round"
              strokeLinejoin="round"
          ...
          <span className="floating-number">
            {user && user.cart && user.cart.items && user.cart.items.length
      ...
      <div
        className={
          toggle ? "sidebar-wrapper d-block" : "sidebar-wrapper d-none"
        }
      >
                ...
                .map((value, i) => {
                  return (
                    <li
                      key={i}
                      className={
                        path == value.name || category == value.name
                          ? "active"
                          : ""
                      }
      ...
      <div
        className={
          toggleCart || cart_flag
            ? "cart-wrapper d-block"
            : "cart-wrapper d-none"
        }
      >
        <ul className="sidebar-list">
                    ...
                    <div className="item-wrapper" key={key}>
                      ...
                      <div className="item-details">
                        <h1
                          ...
                          onClick={() => {
                            redirectTo(
                              `/product/${value.category}/${value.product_id}`
                            );
                          }}
                        >
                          {value.name}
      ...
      {showSignUp ? (
        <>
          <div
            className={
              toggleSignIn
                ? "sign-in-wrapper d-block"
                : "sign-in-wrapper d-none"
            }
          >
            ...
            <form name="login-form" onSubmit={(e) => handleLogin(e)}>
              ...
              <div className="input-wrapper">
                <div className="d-flex justify-content-between w-100 p-0">
                  ...
                  <label
                    className="text-label forgot-link w-auto"
                    onClick={() => {
                      setToggleSignIn(true);
                      setShowLogin(false);
                      setToggle(false);
      ...
      {showOtpFields ? (
        <>
          ...
          >
            ...
            <input className="footer-btn" type="submit" value="Sign up"></input>
            <h3
              className="footer-text"
              onClick={() => {
                setShowSignUp(true);
      ...
      <div
        className={
          dropdown ? "dropdown-wrapper d-block" : "dropdown-wrapper d-none"
        }
      >
        ...
        <div className="list-wrapper">
          <div
            className="list"
            onClick={() => redirectTo("/password/reset/new")}
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="12"
            ...
            >
              ...
              >
                <path
                  id="Path_24"
                  data-name="Path 24"
                  d="M13.333,14V12.667A2.667,2.667,0,0,0,10.667,10H5.333a2.667,2.667,0,0,0-2.667,2.667V14"
                  fill="none"
                  stroke="#000"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <path
                  id="Path_25"
                  data-name="Path 25"
                  d="M10.667,4.667A2.667,2.667,0,1,1,8,2a2.667,2.667,0,0,1,2.667,2.667Z"
                  fill="none"
                  stroke="#000"
                  strokeLinecap="round"
                  strokeLinejoin="round"
            ...
            >
              ...
              >
                <path
                  id="Path_21"
                  data-name="Path 21"
                  d="M4,1.333,2,4v9.333a1.333,1.333,0,0,0,1.333,1.333h9.333A1.333,1.333,0,0,0,14,13.333V4L12,1.333Z"
                  fill="none"
                  stroke="#000"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <path
                  id="Path_23"
                  data-name="Path 23"
                  d="M10.667,6.667a2.667,2.667,0,1,1-5.333,0"
                  fill="none"
                  stroke="#000"
                  strokeLinecap="round"
                  strokeLinejoin="round"
          ...
          <div className="list">
            ...
            >
              <g
                id="Icon_feather-log-in"
                data-name="Icon feather-log-in"
                transform="translate(-1.333 -1.333)"
              >
                <path
                  id="Path_16"
                  data-name="Path 16"
                  d="M10,2h2.667A1.333,1.333,0,0,1,14,3.333v9.333A1.333,1.333,0,0,1,12.667,14H10"
                  fill="none"
                  stroke="#000"
                  strokeLinecap="round"
                  strokeLinejoin="round"
                ...
                <path
                  id="Path_17"
                  data-name="Path 17"
                  d="M6.667,11.333,10,8,6.667,4.667"
                  fill="none"
                  stroke="#000"
                  strokeLinecap="round"
                  strokeLinejoin="round"
