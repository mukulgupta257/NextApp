...
export default function AdminPanel() {
  ...
  const removeProduct = () => {
    axios
      .delete(`${APIUrls.product}/${currentID}`)
      .then((res) => {
        alert.show("Deleted", {
          type: "info",
        });
  ...
  return (
    <div className="admin-wrapper d-flex justify-content-center flex-column">
      <div className="button-wrapper justify-content-end d-flex mb-4 mt-4">
        ...
        <button
          className="ms-2"
          onClick={() => router.push("/admin/banner/order")}
        >
          View Orders
        </button>
      </div>
      <div className="product mt-4 d-flex justify-content-center table-wrapper flex-column">
          ...
          <tbody>
                      ...
                      <span onClick={() => redirectTo(`/admin/${d._id}`)}>
                        ...
                        >
                          <g>
                            <g>
                              <path
                                d="M100.911,419.404l123.8-51c3.1-2.1,6.2-4.2,8.3-6.2l203.9-248.6c6.2-9.4,5.2-21.8-3.1-29.1l-96.8-80.1
			c-8-5.9-20.3-6.8-28.1,3.1l-204.9,248.5c-2.1,3.1-3.1,6.2-4.2,9.4l-26,132.1C72.511,420.104,90.611,424.004,100.911,419.404z
			 M326.611,49.004l65.5,54.1l-177.7,217.1l-64.9-53.7L326.611,49.004z M133.411,306.904l44.4,36.8l-57.2,23.6L133.411,306.904z"
                              />
                              <path
                                d="M469.111,448.504h-349.5c0,0-72.5,3.4-75.2-15.2c0-1-1.8-5.6,7.6-17c7.3-9.4,6.2-21.8-2.1-29.1
		...
		c-0.6,0-1-0.4-1-1V28c0-0.6,0.4-1,1-1h2c0.6,0,1,0.4,1,1V42z"
                    ...
                    <td>
                      <div className="item-wrapper">
                        ...
                        <div className="text-wrapper">
                          <p>
                            <strong className="p-0">{d.title}</strong>
                          </p>
                          <p>{d.description}</p>
                        </div>
                      </div>
                    ...
                    <td className="th-center">
                      {d.isBestSeller ? "Yes" : "No"}
                    </td>
                    <td>
                      {d.variants.length > 0
                        ? d.variants.map((data,i) => {
                            return (
                              <div
              ...
              <tr>
                <td className="th-center" colSpan="8">
                  No data
                </td>
              </tr>
            )}
