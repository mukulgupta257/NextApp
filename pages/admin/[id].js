...
const Admin = () => {
  ...
  useEffect(() => {
    if (id && id == "add-product") {
      if (categoryList.length > 0) setCategory(categoryList[0].name);
    }
  }, [categoryList, id]);
  useEffect(() => {
            ...
            product_description: {
              ...
              core_description:
                descriptionList && descriptionList.length > 0
                  ? descriptionList.filter((d) => d.checked == true)
                  : [],
            },
          },
        ];
    ...
    axios
      ...
      .then((res) => {
        ...
        if (
          ...
          data.product_description.core_description
        ) {
        ...
        if (
          data.product_description &&
          data.product_description.banner_images
        ) {
      ...
      <div className="add-product-wrapper row">
        <form onSubmit={(e) => handleAddProduct(e)}>
          <div className="button-wrapepr col-8">
            <button
              type="button"
              className="back-btn col-12 container"
            ...
            <div className="product-details col-lg-8 col-12">
              ...
              <div className="d-flex flex-md-row flex-column bg-blue">
                ...
                <div className="col-md-6">
                  ...
                  {displayImage && (
                    <div className="input-wrapper">
                      <Image src={displayImage} width={40} height={40} alt="" />
                    </div>
                  )}
                  <div className="input-wrapper">
                    <label>
              ...
              <div className="table-wrapper">
                <table className="w-100">
                  <thead>
                    ...
                    <th>
                      Sale Price<span className="required-field">*</span>
                    </th>
                    <th>
                    ...
                    <th className="th-center">
                      Display Image<span className="required-field">*</span>
                    </th>
                    <th className="th-center">
                      Thumbnail Images<span className="required-field">*</span>
                    </th>
                    <th>
                      Description<span className="required-field">*</span>
                    </th>
				...
				C181.238,11.71,169.528,0,155.135,0h-30.556c-14.392,0-26.102,11.71-26.102,26.102v8.507h13.618V26.102z"
                              ...
                              <td>
                                <div className="input-wrapper">
                                  ...
                                  >
                                    {d.color.toLowerCase() == "red" ||
                                    d.color.toLowerCase() == "white" ||
                                    d.color.toLowerCase() == "black" ? (
                                      <>
                                      ...
                                      <>
                                        <option value={d.color.toLowerCase()}>
                                          {d.color}
                                        </option>
                                        <option value="White">White</option>
                                        <option value="Black">Black</option>
                              ...
                              <td>
                                <div className="input-wrapper w-small">
                                  <input
                                    ...
                                    value={d.price}
                                    onChange={(e) =>
                                      dataModify(index, e.target.value, "price")
                                    }
                                  ></input>
                                </div>
                              </td>
                              ...
                              <td>
                                <div className="input-wrapper w-small">
                                  <input
                                    ...
                                    value={d.qty}
                                    onChange={(e) =>
                                      dataModify(index, e.target.value, "qty")
                                    }
                                  ></input>
                                </div>
                              </td>
